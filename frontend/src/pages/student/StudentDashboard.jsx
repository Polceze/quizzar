    ...
    <div className="p-8 bg-blue-100 rounded-lg shadow-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Link 
                ...
                className="p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300 transform hover:scale-[1.02] border-t-4 border-green-500"
                >
                <h2 className="text-xl font-semibold text-green-700 mb-2">Exam Results</h2>
            ...
            <Link 
                ...
                >
                <h2 className="text-xl font-semibold text-purple-700 mb-2">Performance Analytics</h2>
                <p className="text-gray-600">View detailed performance insights and progress tracking</p>
            </Link>
