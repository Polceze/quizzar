      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto">
            Create intelligent exams, manage classrooms, and streamline
            assessments with Quizzar. Perfect for educational institutions
            looking to modernize their examination process.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white p-8 rounded-lg shadow-sm">
            ...
            <p className="text-gray-600">
              Generate intelligent exam questions from study materials using
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm">
            ...
            <p className="text-gray-600">
              Complete school administration with teacher approvals, student
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm">
            ...
            <p className="text-gray-600">
              Advanced anti-cheating features including tab-switch and
        ...
        <div className="bg-white rounded-lg shadow-sm p-12 text-center">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Complete your profile as teacher or student
              </p>
            </div>
            <div className="text-center">
              <div className="w-20 h-20 bg-indigo-100 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-sm text-gray-600">
                Teachers create units, students enroll
              </p>
            </div>
            <div className="text-center">
              <div className="w-20 h-20 bg-indigo-100 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-sm text-gray-600">
                AI-powered exam creation and secure testing
              </p>
            </div>
          </div>
        </div>
